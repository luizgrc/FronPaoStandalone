...
$("#btnScreen").click(function (event) {
    $("#idMenuBar").toggle();
    if ($("#idMenuBar").css('display') == 'none') {
        $('#content').removeClass('col-lg-9 col-sm-9');
        $('#content').addClass('col-lg-12 col-sm-12');
        $('#iconScreen').removeClass('glyphicon glyphicon-fullscreen');
        $('#iconScreen').addClass('glyphicon glyphicon-resize-small');
    } else {
        $('#content').removeClass('col-lg-12 col-sm-12');
        $('#content').addClass('col-lg-9 col-sm-9');
        $('#iconScreen').removeClass('glyphicon glyphicon-resize-small');
        $('#iconScreen').addClass('glyphicon glyphicon-fullscreen');
    }
});
